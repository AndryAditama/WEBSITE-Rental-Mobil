                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="merek" id="merek" class="form-control <?= ($validation->hasError('merek')) ? 'is-invalid' : ''; ?>" value="<?= old("merek"); ?>">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_pol" id="no_pol" class="form-control <?= ($validation->hasError('no_pol')) ? 'is-invalid' : ''; ?>" value="<?= old("no_pol"); ?>">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control <?= ($validation->hasError('jumlah_kursi')) ? 'is-invalid' : ''; ?>" name="jumlah_kursi" id="jumlah_kursi" min="1" max="10" value="<?= old("jumlah_kursi"); ?>">
