...
<div class="container-fluid">
         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-sm-6 my-2">
                  ...
                  <input type="time" class="form-control" id="appt" name="waktu_boking" value="<?= date("H:i"); ?>" readonly>
               </div>
               <div class="col-sm-6 my-2">
   ...
   <div class="card mt-2 mb-2">
      ...
      <div class="card-body" style="overflow-x: auto;">
         ...
         <a href="<?= site_url('admin/refresh_jadwal'); ?>" class="btn btn-warning mb-2"><i class="fas fa-sync-alt"></i> Refresh</a>
