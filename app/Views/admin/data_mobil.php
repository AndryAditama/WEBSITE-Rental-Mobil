                    ...
                    <?php foreach ($mobil as $m) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('admin/hapus_mobil'); ?>/<?= $m['id_mobil']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus data')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
